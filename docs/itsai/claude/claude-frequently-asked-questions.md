...
ai_description: Syracuse University users retain data ownership and can upload all
  university data classifications to Claude when logged in with NetID credentials.
date: '2025-10-01'
lastmod: '2026-03-13'
...
Claude Code is a way to consume Claude models via API access and the Claude Code terminal. The Claude Enterprise License does not include Claude Code, but users can purchase access via a credit card. [Learn More](https://shahaank.github.io/su-kb-pages-demo/itsai/claude/purchase-claude-code-and-claude-api-access/).
