...
ai_description: This page provides instructions for setting up Claude Code at Syracuse
  University, including access methods and installation of development tools.
date: '2026-04-14'
lastmod: '2026-04-15'
...
Using one of the methods for obtaining Claude Code described on the page: [Purchase Claude Code and Claude API Access - Artificial Intelligence (AI) - Answers](https://shahaank.github.io/su-kb-pages-demo/itsai/claude/purchase-claude-code-and-claude-api-access/)
...
2. **Choose your text display style.** Select whichever option you prefer.
3. **Select "Anthropic Console account"** (option 2) when prompted for your login method.
4. **Sign in.** A browser window will open, and sign in with your `netid@syr.edu` credentials. If prompted, select the **Syracuse University** organization.
5. **Authorize Claude Code** when prompted in the browser.
6. **Return to the terminal** and press Enter twice to accept and trust the folder
...
GitHub at Syracuse University - Information Technology Support - Answers
